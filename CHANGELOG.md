...
* **ui:** update lattice to 0.70 and adapt to renamed enums ([9e1cb59](https://github.com/bambamboole/laravel-oidc/commit/9e1cb59edf07e9ca2ae5d2c8aad954c9475d7936))
...
* **ui:** upgrade to lattice 0.57

### Bug Fixes

* **ui:** upgrade to lattice 0.57 ([0de84be](https://github.com/bambamboole/laravel-oidc/commit/0de84bef46bbbc92c134b486ebcdbe753ef94b79))
...
* require lattice 0.48 ([782467e](https://github.com/bambamboole/laravel-oidc/commit/782467e14836513c1a0a01ed4e7425e01e7bc601))
...
* **client:** fixed route table, slimmer validator and testing internals ([4813575](https://github.com/bambamboole/laravel-oidc/commit/4813575730006ec5f3389a786f738d64005a7650))
* **server:** boot-safe Oidc facade, leaner internals, new auth APIs ([0e57d32](https://github.com/bambamboole/laravel-oidc/commit/0e57d3243313cbcd50343606381c62654ce07c21))
* **server:** enrollable webauthn and recovery-code providers, retire legacy TOTP endpoints ([1dca842](https://github.com/bambamboole/laravel-oidc/commit/1dca8428ef98f5e28e5c2ad471f8d9e36a5dd4fb))
* **server:** native uuid columns for user references ([b14b44a](https://github.com/bambamboole/laravel-oidc/commit/b14b44a1aa0e24679716fdc0251b8bb0ae81625c))
* **server:** offer every challengeable factor and allow switching mid-challenge ([7cae8da](https://github.com/bambamboole/laravel-oidc/commit/7cae8daa8d5e5fb2d4d6bc855c02f83e27d912e9))
* **server:** single passkey registration path and strict pending-challenge state ([57f37ff](https://github.com/bambamboole/laravel-oidc/commit/57f37ff8982721ba4751b97a586859a7929cead3))
* **server:** uuid primary keys for every package table ([26f7455](https://github.com/bambamboole/laravel-oidc/commit/26f7455594314cc3d0a72f2816dfd9b29524e2ae))
* **ui:** drive passkey registration through the generic webauthn ceremony ([6fd44cb](https://github.com/bambamboole/laravel-oidc/commit/6fd44cbefb3574e31c061e3653d13c2321f60ea3))
* **ui:** named-argument PasskeyVerify, inlined single-use seams ([0cbafe5](https://github.com/bambamboole/laravel-oidc/commit/0cbafe559c188285985ec4ce92284cc2a642eb1e))
* **ui:** provider-parameterized MFA components and challenge factor picker ([53d3323](https://github.com/bambamboole/laravel-oidc/commit/53d33230b4450dc45b92306836eec47d2c0ecf86))
* **ui:** unified methods table, recovery-code display, per-enrollment picker ([363fd24](https://github.com/bambamboole/laravel-oidc/commit/363fd2412acbb27658e9c3043a8eee15c4bc94e1))


### Refactoring

* **server:** providers own factor storage, drop FactorAuthenticatable ([60b4e3d](https://github.com/bambamboole/laravel-oidc/commit/60b4e3d14c8adf5bb38070fd995b0a0fabe6cc8d))


### Documentation

* cover the remaining 0.11.0 breaking changes in the upgrade guide ([16a071b](https://github.com/bambamboole/laravel-oidc/commit/16a071b46bdcfe32d1c326e14b97891be2256af5))
* upgrade guide and self-SSO testing recipe ([fdc9c7a](https://github.com/bambamboole/laravel-oidc/commit/fdc9c7a9a00201b9e5b9ce9bb7860aa1b7572e51))

## [0.10.2](https://github.com/bambamboole/laravel-oidc/compare/v0.10.1...v0.10.2) (2026-07-30)


### Bug Fixes

* allow lattice 0.28 and newer ([852baaa](https://github.com/bambamboole/laravel-oidc/commit/852baaaec45e45c29dc325833d039e703a0bed61))
* bound the lattice constraint below 1.0 ([39fd233](https://github.com/bambamboole/laravel-oidc/commit/39fd2337db5bf4fa68f788815cfd36e62f0d377d))

## [0.10.1](https://github.com/bambamboole/laravel-oidc/compare/v0.10.0...v0.10.1) (2026-07-29)


### Bug Fixes

* allow lattice 0.28 ([0981808](https://github.com/bambamboole/laravel-oidc/commit/09818083806cb9d9c1df36073fd0e7656b8333cb))
