...
class WorkbenchServiceProvider extends ServiceProvider
{
    ...
    {
        // The server package deliberately leaves `login`/`logout` route ownership to the
        // relying party, so the workbench stands in for that host application here —
        // exactly what VerifyEmailPage's log-out link needs to resolve.
