 ...
 * @method static \Bambamboole\LaravelOidc\Clients\FirstPartyClientProvisioningResult provisionFirstPartyClient(string $name, string[] $redirectUris, string[] $postLogoutRedirectUris = [], string[] $allowedExchangeAudiences = [], ?string $adoptClientId = null, bool $rotateSecret = false, ?string $existingClientSecret = null)
