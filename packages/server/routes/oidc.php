...
Route::middleware($shared)->group(function () use ($guest, $authenticated, $passwordConfirmed): void {
    ...
    Route::get('.well-known/oauth-authorization-server/{path?}', AuthorizationServerMetadataController::class)
        ->where('path', '.*')
